...
const testimonials = [
  {
    ...
    name: "Sample Client",
    role: "Placeholder — Commercial Film",
  ...
  },
  {
    quote:
      "This is a placeholder testimonial. Real client feedback for this category will be featured here once available.",
    name: "Sample Client",
    role: "Placeholder — Event Coverage",
  ...
  },
  {
    quote:
      "This is a placeholder testimonial. Real client feedback for this category will be featured here once available.",
    name: "Sample Client",
    role: "Placeholder — Studio Photography",
  ...
  },
  {
    quote:
      "This is a placeholder testimonial. Real client feedback for this category will be featured here once available.",
    name: "Sample Client",
    role: "Placeholder — Content Series",
  ...
  },
  {
    quote:
      "This is a placeholder testimonial. Real client feedback for this category will be featured here once available.",
    name: "Sample Client",
    role: "Placeholder — Media Training",
    ...
    <section className="relative bg-ink py-24 px-6 overflow-hidden text-paper">
      ...
      >
        ...
        <p className="mt-4 text-sm sm:text-base text-paper/60 max-w-lg mx-auto">
          Real reviews are being gathered — the layout below shows how
          they&apos;ll appear once published.
        </p>
      </motion.div>
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        <div className="relative p-8 sm:p-12 rounded-3xl bg-white/[0.03] backdrop-blur-2xl border border-white/10 shadow-2xl min-h-[320px] flex flex-col justify-between">
          <div className="flex items-center justify-between mb-6">
            ...
            {/* Rating omitted — a star rating is itself a factual claim we can't fabricate */}
          </div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="mt-8 flex items-center gap-4 pt-6 border-t border-white/10">
                  <div className="relative w-12 h-12 rounded-full overflow-hidden border border-primary/30 bg-white/10 flex-shrink-0 flex items-center justify-center font-bold text-primary">
